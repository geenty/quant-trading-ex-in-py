"""
Example 3.8: A Simple Mean Reverting Model Adjusted!
    Using opening price this time.
...
spx_df = pd.read_table('data/SPX_op_20071123.txt')  # data provided from site, closed
